...
const PhotoVerification = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-eco-primary-50 to-eco-sky-light flex items-center justify-center">
        <LoadingSpinner />
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-eco-primary-50 to-eco-sky-light py-12 px-4 sm:px-6 lg:px-8">
